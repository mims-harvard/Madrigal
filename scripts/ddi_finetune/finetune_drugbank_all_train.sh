#!/bin/bash
#SBATCH -J finetune_drugbank_all_train
...
config_file="configs/ddi_finetune/DrugBank/bottleneck_all_available.yaml"
checkpoint="DrugBank/checkpoint_1000.pt"          # relative to CL_CKPT_DIR
